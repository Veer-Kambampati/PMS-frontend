...
class ActionStatus extends React.Component {
  ...
  handleDone = (e) => {
    ...
    e.stopPropagation();
    let reqUrl = "http://localhost:8080/projectManagement/updateStatus";
    const json = {
  ...
  render() {
    ...
    return (
      <>
        <select
          id="small"
          class="block p-2 w-36 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
...
export default withRouter(ActionStatus);
