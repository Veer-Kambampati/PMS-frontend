        ...
        <form style={{ width: "200%" }}>
          <div class="grid gap-6 mb-6 lg:grid-cols-1 mt-7">
            ...
            <div style={{ display: "flex" }}>
              ...
              <input
                ...
                class={`${
                  isEnableEdit ? "bg-gray-50" : "bg-gray-300"
            ...
            <div style={{ display: "flex" }}>
              ...
              <textarea
                ...
                class={`${
                  isEnableEdit ? "bg-gray-50" : "bg-gray-300"
                } form-control block w-full px-3 py-1.5 text-base font-normal text-gray-900 bg-clip-padding border border-solid border-gray-300 rounded-lg transition ease-in-out m-0 focus:ring-gray-900  focus:border-gray-900 `}
          ...
          {!isNew && (
            <div class="mb-6" style={{ display: "flex" }}>
              ...
              <input
                ...
                onChange={(e) => {
                  this.setState({ lastUpdatedTime: e.target.value });
                }}
                class="bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                placeholder="2022-06-06 22:16:18"
                required
                disabled
              />
            </div>
          ...
          {isNew ? (
            <button
              ...
              onClick={this.createProjectData}
            >
              Create
            </button>
